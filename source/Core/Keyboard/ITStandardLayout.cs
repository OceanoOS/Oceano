...
namespace Cosmos.System.ScanMaps
{
    ...
    public class ITStandardLayout : ScanMapBase
    {
        ...
        protected override void InitKeys()
        {
            ...
            Keys.Add(new KeyMapping(0x0D, 'ì', '^', '^', 'ì', '^', 'ì', ConsoleKeyEx.Equal));
            ...
            Keys.Add(new KeyMapping(0x1A, 'è', 'é', 'è', 'é', 'è', 'é', ConsoleKeyEx.LBracket));
            ...
            Keys.Add(new KeyMapping(0x27, 'ò', 'ç', 'ò', 'ò', 'ç', 'ç', ConsoleKeyEx.Semicolon));
            Keys.Add(new KeyMapping(0x28, 'à', '°', '°', '°', 'à', 'à', ConsoleKeyEx.Apostrophe));
            ...
            Keys.Add(new KeyMapping(0x35, '-', '_', '-', '-', '_', '-', ConsoleKeyEx.Slash)); // also numpad divide
            /* Right Shift */
