...
{
    /// <summary>
    /// US_Standard class. Represent IT_Standard keyboard layout.
    /// </summary>
    public class IT_Standard : ScanMapBase
    {
        /// <summary>
        /// Create new instance of the <see cref="IT_Standard"/> class.
        /// </summary>
        public IT_Standard()
        {
        }
        ...
        protected override void InitKeys()
        {
            ...
            _keys.Add(new KeyMapping(0x1A, 'è', 'é', 'è', 'é', 'è', 'é', ConsoleKeyEx.LBracket));
