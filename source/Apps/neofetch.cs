...
namespace Oceano.Apps
{
    public class neofetch
    {
        ...
        public static void init() {
            ...
            Console.Write(@"  _.====.._               "); Console.Write("   root"); Console.ForegroundColor = ConsoleColor.White;Console.Write("@");Console.ForegroundColor = ConsoleColor.Cyan; Console.Write("oceano");
            Console.WriteLine();
