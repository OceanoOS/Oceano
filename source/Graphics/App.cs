...
namespace Oceano.Graphics
{
    public class App
    {
        ...
        public void Update()
        {
            ...
            {
                Display.vMWareSVGAII.DrawACSIIString(name, (uint)Color.White.ToArgb(), (uint)(dockX - ((name.Length * 8) / 2) + dockWidth / 2), dockY - 20);
            }
            ...
            */
            Display.vMWareSVGAII.DoubleBuffer_DrawFillRectangle(_x, _y, _width, _height, (uint)Color.FromArgb(32,32,32).ToArgb());
            Display.vMWareSVGAII.DoubleBuffer_DrawRectangle((uint)Color.Cyan.ToArgb(), (int)_x, (int)_y, (int)_width, (int)_height);

            Display.vMWareSVGAII.DrawACSIIString(name, (uint)Color.White.ToArgb(), _x + 2, _y + 2);
